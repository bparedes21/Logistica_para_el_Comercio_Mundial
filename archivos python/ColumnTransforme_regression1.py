def funcion_ColumnTransforme(df):
    ...
    df1.columns=col
    df[col]=df1[col]
    col=["A","B","C","D","F","Road","Ship","Flight","Gender_Binary","Customer_rating","Gender",'Warehouse_block','Mode_of_Shipment','Product_importance']
...
def funcion_regression_log(df_train,df1_test):
    ...
    X = df_train.iloc[:, [0,1,2,3,4]].values
    ...
    X = df1_test.iloc[:, [0,1,2,3,4]].values
